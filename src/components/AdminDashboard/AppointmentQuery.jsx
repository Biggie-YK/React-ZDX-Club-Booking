// src/components/AdminDashboard/AppointmentQuery.jsx
...
export default function AppointmentQuery({
  ...
  }, [sortedBookings, serviceFilter, timeFilter, statusFilter]);
        ...
        <div className="check-border-inside px-72 py-48">
          <div className="d-flex justify-content-between mb-4">
            ...
            <button
              ...
              title="重新整理"
            >
              <img src={iconRefresh} alt="refresh" className="align-bottom" />
            </button>
          </div>
